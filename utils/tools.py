            ...
            for line in file:
                ...
                if trimmed_line != "":
                    if "#genre#" in trimmed_line:
                        ...
                        m3u_output += f'#EXTINF:-1 tvg-name="{processed_channel_name}" tvg-logo="{join_url(config.cdn_url, f'https://raw.githubusercontent.com/pdd520/pdd520/main/img/{processed_channel_name}.png')}"'
                        if current_group:
